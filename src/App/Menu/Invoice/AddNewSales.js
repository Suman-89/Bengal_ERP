import { CButton, CCard, CCardBody, CCardHeader, CCol, CForm, CFormCheck, CFormFeedback, CFormInput, CFormLabel, CFormSelect, CInputGroup, CInputGroupText, CRow } from '@coreui/react'
...
const AddSalesForm = () => {
  ...
  return (
    <>
    <CButton color="secondary" type="submit" className='mb-3'>
          Back
        </CButton>
    <CForm
