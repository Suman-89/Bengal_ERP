...
const AddNewPurchase = React.lazy(() => import('../App/Menu/Invoice/AddNewPurchase'))
...
const AppRoutes = [
  ...
  { path: '/cashbook', name: 'Rokad', element: CashBook, exact: true },
  ...
  { path: '/purchase/addnewpurchase', name: 'Add New Purchase', element: AddNewPurchase, exact: true },
  ...
  {
    path: '/pursaleregister',
    name: 'Purchase & Sales Register ',
    element: PurSaleRegister,
    exact: true,
  },
  {
    path: '/headwisegraphicalreport ',
    name: 'Head Wise Graphical Report ',
    element: HeadWiseGraph,
    exact: true,
  },
  {
    path: '/salesgraphicalreport ',
